...
class TSS:
  def __init__(self, identifier, gene_id, chrom, pos, gene_seq, is_active, strand):
    """
    初始化 TSS 实例。
    :param identifier: str, TSS 的唯一标识符
    :param gene_id: str, 所属基因的 ID
    :param chrom: str, 所在染色体
    :param pos: int, TSS 的位置
    :param gene_seq: int, 序列索引
    :param is_active: bool, 是否活跃
    :param strand: str, 正链或负链
    """
